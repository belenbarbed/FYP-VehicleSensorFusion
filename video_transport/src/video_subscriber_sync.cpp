...
int main(int argc, char **argv)
{
  ...
  // image_transport::SubscriberFilter sub_2(it, "/pixel_2/camera0/image", 1);
  // image_transport::SubscriberFilter sub_3(it, "/pixel_3/camera0/image", 1);
  ...
  > MySyncPolicy;
  message_filters::Synchronizer<MySyncPolicy> sync(MySyncPolicy(10), sub_1, sub_pc);
